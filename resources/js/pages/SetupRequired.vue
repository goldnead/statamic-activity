<script setup>
/**
 * What a CP screen shows when its database tables are not there yet.
 *
...
<template>
    ...
    <!--
        `fieldtype-table`, not `database`: core's icon set (v6.31.0) has no
        `database`, and <Icon> renders a name it does not know as an empty box
        rather than as an error. Checked against
        vendor/statamic/cms/resources/svg/icons/.
    -->
