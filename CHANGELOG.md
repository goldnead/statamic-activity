...
`goldnead/statamic-leadhub` (`^1.4`) and `goldnead/statamic-marketing` (`^1.4`) were pinned to the 1.x line. LeadHub 2.0.0 and Marketing 2.0.0 carry no code change over 1.12.2
